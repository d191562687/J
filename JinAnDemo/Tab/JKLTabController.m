...
-(void)viewDidLoad
{
    ...
    [self addSubController:HomeVC andTitle:@"食药" andImage:[UIImage imageNamed:@"tab_jkl_normal" ] andSelectedImage:[UIImage imageNamed:@"tab_jkl_selected"]];
    ...
    [self addSubController:ShopVC andTitle:@"定位" andImage:[UIImage imageNamed:@"tab_cart_normal"] andSelectedImage:[UIImage imageNamed:@"tab_cart_selected"]];
    
    
    //创建我的控制器
    JKLMeController *MeVC = [[JKLMeController alloc]init];
    MeVC.view.backgroundColor = [UIColor whiteColor];
    [self addSubController:MeVC andTitle:@"个人" andImage:[UIImage imageNamed:@"tab_my_normal"] andSelectedImage:[UIImage imageNamed:@"tab_my_selected"]];
}
