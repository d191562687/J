...
- (void)createQR1
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:@"191562687@qq.com" size:_qrImgView.bounds.size];
...
- (void)createQR2
{
    ...
    UIImage *image = [LBXScanWrapper createQRWithString:@"191562687@qq.com" size:_qrImgView.bounds.size];
    //二维码上色
...
- (void)createQR3
{
    ...
    _qrImgView.image = [LBXScanWrapper createQRWithString:@"191562687@qq.com"
